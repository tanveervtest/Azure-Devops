...
public class TC_004 extends BaseDriverUtil {
...
//			loginPage.logout();
	...
	@Test(priority = 1, enabled = true, description = "TC_004")
...
//		driver.get("https://dev-portal.efuelsystems.com");
		...
		extentTest.info("TC004 executed successfully");
		Assert.assertEquals(true, true);
		extentTest.log(Status.PASS, MarkupHelper.createLabel("TC004 executed successfully", ExtentColor.GREEN));
	}
